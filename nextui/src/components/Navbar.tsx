...
export function Navbar() {
    ...
    return (
        <>
                                    ...
                                    >
                                        <div className="flex flex-col py-2">
                                            ...
                                            <button
                                                ...
                                                className="px-4 py-2 text-left text-white/70 hover:text-white hover:bg-white/10 transition-colors"
                                            >
                                                Stat
                                            </button>
                                        </div>
            ...
            <StatModal isOpen={isStatOpen} onClose={() => setIsStatOpen(false)} />
        </>
    );
}
