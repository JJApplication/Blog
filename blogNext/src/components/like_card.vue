<template>
  <div class="like-card">
    ...
    <el-table :data="like_list" max-height="calc(100vh - 150px)" border style="width: 100%; overflow-y: auto">
      ...
      <el-table-column sortable width="150" align="center" label="点赞数">
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button size="mini" type="primary" @click="handleUpdate(scope.$index, scope.row.name, scope.row.like)">
            更新
          </el-button>
