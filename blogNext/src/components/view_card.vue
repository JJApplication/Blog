<template>
  <div class="view-card">
    ...
    <!--        最顶部一定是all-->
    <el-table :data="view_list" max-height="calc(100vh - 150px)" border style="width: 100%; overflow-y: auto">
      ...
      <el-table-column sortable width="120" label="访问量">
      ...
      <el-table-column label="操作" width="80">
        <template slot-scope="scope">
          <el-button size="mini" type="primary" @click="handleUpdate(scope.$index, scope.row.name, scope.row.view)">
            更新
          </el-button>
        </template>
      </el-table-column>
