<template>
  <div class="about">
    <div class="head">
      ...
      <p>
        博客项目开始于2020年，迭代更新了很多版本， 一开始只是简单地做一个博客网站。
        <br />
    ...
    <div style="margin-top: 40px">
      <ul>
        我的个人主页
        <a :href="custom.site_url">{{ custom.site_name }}</a>
      </ul>
      <ul>
        我的Github
        <a :href="'https://github.com/' + custom.github">{{ custom.github }}</a>
      </ul>
    </div>
    <div class="thanks">
      ...
      <ul>
        证书
        <a href="https://freessl.cn/">FreeSSL</a>
      </ul>
      <ur>
        图标
