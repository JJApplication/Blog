<template>
  <div class="message_card">
    ...
    <el-table :data="message_list" max-height="calc(100vh - 150px)" border style="width: 100%; overflow-y: auto">
      <el-table-column prop="primary_id" label="ID" sortable width="80"></el-table-column>
      <el-table-column prop="user" label="用户" sortable width="120"></el-table-column>
      <el-table-column prop="date" sortable width="160" label="留言日期"></el-table-column>
      <el-table-column sortable label="留言">
      ...
      <el-table-column label="操作" width="150">
        <template slot-scope="scope">
          <el-button
            size="mini"
            type="primary"
            @click="handleUpdate(scope.$index, scope.row.primary_id, scope.row.message)"
          >
            更新
          </el-button>
          <el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row.primary_id)">
            删除
          </el-button>
        </template>
      </el-table-column>
